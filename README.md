...
```
TreeScore = 0.35·평판 + 0.15·화제성 + 0.15·투명성 + 0.35·진입난이도
```
...
랭킹 구조 검토와 반복 개선 지표는 [docs/RANKING_REVIEW.md](docs/RANKING_REVIEW.md)에
정리되어 있습니다. 실제 데이터 수집마다 날짜 확인율·과목별 순위 대상 수 등을
180일간 기록하고, 이전 회차보다 감소하면 점검 경고를 남깁니다.
