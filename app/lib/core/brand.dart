...
class Brand {
  ...
  static const tagline = '우리 아이에게 맞는 학원 찾기';
  static const description = '학년·수업·위치와 후기 근거를 함께 살펴보는 학원 안내';

  /// 이름의 유래를 화면에서 한 번은 설명해 준다.
  static const nameOrigin = '조선왕조실록이 사실을 있는 그대로 남겼듯, 학원 정보를 검증된 기록으로 남깁니다.';
