...
source_id: 0f8817c9-9ea6-4e3a-a9ed-b16ece5e7690
source_status: open
entity_type: academy
...
- 이 사례의 글: https://cafe.naver.com/car1143337/81437 '불당동 새로운 학원' — 천안 불당동의 **동명 학원**(전화 041-909-4624, 위키 산문). 카페 학원평가 정형글의 '[레벨테스트] 있음' 이 sel.test_exists 가 됐다. 원인이 둘 겹쳤다: 제목의 '새로운 학원' 이 띄어 쓴 구(trade_seam) + 제목의 동이 우리 학군 밖(`analyze.foreign_dong` analyze.py:861 · branches.py:167, 재현 True). 그래서 8/31 낱말 수정으로는 안 빠지고 8/31·9/3 산출물에 **홀로 남았다가**(claimId dc46c229f6ef2694) 9/4 dd27c73b0 에서 사라졌다. 같은 작성자의 붙여 쓴 글(/82246 '불당동 교육의 끝판왕.(새로운학원의…)') 도 foreign_dong 과 wiki `unusable` 두 겹으로 막힌다.
...
- 야간 산출물(캐시 아님): origin/main 마지막 데이터 커밋 **0c2e61f3f** (09-07 22:25 UTC, run 34164667543; 진단이 본 8c39e4ea8 보다 3회차 뒤). 3000040050: 표본 **0** · notRanked '과목 미상' · subjects [general] · selectivityEvidence 0 · evidence 0 · claim_id dc46c229f6ef2694 0건 · '불당동' 0건 (학폭·싸대기·인수하기·스터디카페·청라·불당동 전부 0). 8c39e4ea8 동일. 표본 이력(회차별): 8/29 168 → 8/30 166 → 8/31 20(7f6ca1049) → 9/3 24 → 9/4 **0**(dd27c73b0) → 9/5 0(notRanked 부터) → 9/7 0.
