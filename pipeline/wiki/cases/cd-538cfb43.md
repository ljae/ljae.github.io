...
source_id: 538cfb43-2352-4188-8978-966bc1e98e3e
source_status: open
entity_type: academy
...
<!-- auto:report -->
- 주장 종류: sel.full
- 인용문: 학원 인계를 마치고 새로 인수하기까지 순서/견적 공유 /마감합니다.
- 내용:
  > 학원 인수 글입니다. 전혀 상관없는 글입니다.
<!-- /auto:report -->
...
- 이 사례의 글: https://cafe.naver.com/fightingpiano/148934 '학원 인계를 마치고 새로 인수하기까지 순서/견적 공유 /마감합니다' — 피아노학원 운영자의 양도·인수 후기. '마감합니다' 가 sel.full(정원 마감) 로 읽혔다. 8/30 산출물(935e05d9a) claimId eb5bbc93f489ea7a, 8/31 부터 빠짐.
...
- 야간 산출물(캐시 아님): origin/main 마지막 데이터 커밋 **0c2e61f3f** (09-07 22:25 UTC, run 34164667543; 진단이 본 8c39e4ea8 보다 3회차 뒤). 3000040050: 표본 **0** · notRanked '과목 미상' · subjects [general] · selectivityEvidence 0 · evidence 0 · claim_id eb5bbc93f489ea7a 0건 · '인수하기' 0건 (학폭·싸대기·인수하기·스터디카페·청라·불당동 전부 0). 8c39e4ea8 동일. 표본 이력(회차별): 8/29 168 → 8/30 166 → 8/31 20(7f6ca1049) → 9/3 24 → 9/4 **0**(dd27c73b0) → 9/5 0(notRanked 부터) → 9/7 0.
